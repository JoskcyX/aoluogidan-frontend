        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:justify-items-center">
          {team.map((lawyer: any) => (
            <Link
              ...
              className="group w-full max-w-[210px] transition-transform duration-300 hover:-translate-y-1"
            >
              <div className="aspect-[4/5] overflow-hidden rounded-lg bg-surface shadow-sm transition-shadow duration-300 group-hover:shadow-lg">
                {lawyer.photoUrl ? (
                  <Image
                    src={lawyer.photoUrl}
                    alt={lawyer.name}
